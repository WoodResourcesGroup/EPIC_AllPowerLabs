...
select *, ST_distance(st_transform(ST_SetSRID(ST_MakePoint(-119.723942, 36.687512),4326),5070), lemma_dbscanclusters220.geom) as distance from lemma_dbscanclusters220
where ST_DWithin(st_transform(ST_SetSRID(ST_MakePoint(-119.723942, 36.687512),4326),5070), lemma_dbscanclusters220.geom, 100000);
