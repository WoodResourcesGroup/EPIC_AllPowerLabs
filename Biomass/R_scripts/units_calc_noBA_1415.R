...
##setwd(paste(EPIC, "/GIS Data/", sep=""))
##writeOGR(obj=spdf, dsn = "Results_1415", layer = paste("Results_1415_",UNIT,"_noBA", sep=""), driver = "ESRI Shapefile", overwrite_layer = T)
setwd(paste(EPIC, "/GIS Data/Results_1415", sep=""))
save(spdf, file=paste("Results_1415_",UNIT,"_noBA.Rdata", sep=""))

setwd(paste(EPIC, "/GIS Data/Results_1415", sep=""))
load(file=paste("Results_1415_",UNIT,"_noBA.Rdata", sep=""))
...
setwd(paste(EPIC, "/GIS Data/Results_1415", sep=""))
save(sum_D_BM_Mg, file=paste(UNIT, "_1415_D_BM_Mg_noBA.Rdata", sep=""))
remove(sum_D_BM_Mg)
