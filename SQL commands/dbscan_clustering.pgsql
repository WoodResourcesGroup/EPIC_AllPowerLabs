-- Create the clusters
DROP TABLE IF EXISTS lemma_dbscanclusters150;
CREATE TABLE lemmav2.lemma_dbscanclusters150 AS
select key, pol_id, ST_ClusterDBSCAN(geom, eps := 150, minpoints := 112) over () AS cluster_no,
...
DROP TABLE IF EXISTS lemma_dbscanclusters230;
CREATE TABLE lemmav2.lemma_dbscanclusters230 AS
select key, pol_id, ST_ClusterDBSCAN(geom, eps := 230, minpoints := 112) over () AS cluster_no,
"D_BM_kgsum_25CRM", "D_BM_kgsum_3CRM", "D_BMkg_sum25J", "D_BMkg_sum3J", geom
from lemmav2.lemma_totalv2 where county is not NULL;
delete from lemmav2.lemma_dbscanclusters230 where cluster_no is NULL;
alter table lemma_dbscanclusters230 add primary key (key, pol_id, cluster_no);
...
DROP TABLE IF EXISTS lemmav2.lemma_dbscancenters150;
CREATE TABLE lemmav2.lemma_dbscancenters150 AS
SELECT cluster_no, count(*), ST_Centroid(ST_Collect(geom)) AS center_geom, 
sum("D_BM_kgsum_25CRM") as biomass_total25crm, 
sum("D_BM_kgsum_3CRM") as biomass_total3crm, 
sum("D_BMkg_sum25J") as biomass_total25j, 
sum("D_BMkg_sum3J") AS biomass_total3j
FROM lemmav2.lemma_dbscanclusters150
GROUP BY cluster_no;
...
-- Clean up 
delete from lemma_dbscanclusters150 where "D_BM_kgsum_25CRM" = 0 and "D_BM_kgsum_3CRM" = 0;
delete from lemma_dbscanclusters180 where "D_BM_kgsum_25CRM" = 0 and "D_BM_kgsum_3CRM" = 0;
delete from lemma_dbscanclusters200 where "D_BM_kgsum_25CRM" = 0 and "D_BM_kgsum_3CRM" = 0;
delete from lemma_dbscanclusters210 where "D_BM_kgsum_25CRM" = 0 and "D_BM_kgsum_3CRM" = 0;
delete from lemma_dbscanclusters215 where "D_BM_kgsum_25CRM" = 0 and "D_BM_kgsum_3CRM" = 0;
delete from lemma_dbscanclusters225 where "D_BM_kgsum_25CRM" = 0 and "D_BM_kgsum_3CRM" = 0;
delete from lemma_dbscanclusters230 where "D_BM_kgsum_25CRM" = 0 and "D_BM_kgsum_3CRM" = 0;
delete from lemma_dbscanclusters250 where "D_BM_kgsum_25CRM" = 0 and "D_BM_kgsum_3CRM" = 0;
delete from lemma_dbscanclusters300 where "D_BM_kgsum_25CRM" = 0 and "D_BM_kgsum_3CRM" = 0;
...
UPDATE lemmav2.lemma_dbscancenters220 SET kmeans_cluster_quantity = floor(count/136);

alter table lemma_dbscancenters150 drop column if exists sum_distances_sq;
alter table lemma_dbscancenters150 add column sum_distances_sq NUMERIC;
UPDATE lemmav2.lemma_dbscancenters150 SET sum_distances_sq = temp.dist 
from (select lemma_dbscancenters150.cluster_no as clust_no, sum(st_distance(lemma_dbscanclusters150.geom, lemma_dbscancenters150.center_geom)^2.0) as dist from lemma_dbscanclusters150, lemma_dbscancenters150 where 
lemma_dbscancenters150.cluster_no = lemma_dbscanclusters150.cluster_no group by lemma_dbscancenters150.cluster_no) as temp where lemmav2.lemma_dbscancenters150.cluster_no = temp.clust_no; 
alter table lemma_dbscancenters150 drop column if exists standard_distance;
alter table lemma_dbscancenters150 add column standard_distance NUMERIC;
UPDATE lemmav2.lemma_dbscancenters150 SET standard_distance = sqrt(sum_distances_sq/count);
alter table lemma_dbscancenters150 drop column if exists kmeans_cluster_quantity;
alter table lemma_dbscancenters150 add column kmeans_cluster_quantity INT;
UPDATE lemmav2.lemma_dbscancenters150 SET kmeans_cluster_quantity = floor(count/136);
...
UPDATE lemmav2.lemma_dbscancenters180 SET kmeans_cluster_quantity = floor(count/136);
...
UPDATE lemmav2.lemma_dbscancenters200 SET kmeans_cluster_quantity = floor(count/136);
...
UPDATE lemmav2.lemma_dbscancenters210 SET kmeans_cluster_quantity = floor(count/136);
...
UPDATE lemmav2.lemma_dbscancenters215 SET kmeans_cluster_quantity = floor(count/136);
...
UPDATE lemmav2.lemma_dbscancenters225 SET kmeans_cluster_quantity = floor(count/136);
...
alter table lemma_dbscancenters230 drop column if exists kmeans_cluster_quantity;
alter table lemma_dbscancenters230 add column kmeans_cluster_quantity INT;
UPDATE lemmav2.lemma_dbscancenters230 SET kmeans_cluster_quantity = floor(count/136);
...
UPDATE lemmav2.lemma_dbscancenters250 SET kmeans_cluster_quantity = floor(count/136);
...
UPDATE lemmav2.lemma_dbscancenters300 SET kmeans_cluster_quantity = floor(count/136);
...
UPDATE lemmav2.lemma_dbscancenters400 SET kmeans_cluster_quantity = floor(count/136);
